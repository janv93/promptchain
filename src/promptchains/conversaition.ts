...
Scrutinize the answers given by the Challengee until the prompt is solved."
...
Also make sure the verses rhyme. If you don't like verses, ask for improvement etc."

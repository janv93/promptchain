...
Also make sure the verses rhyme. If you don't like some verses, ask for improvement etc. You can make suggestions, but you never provide the answers, that is the job of the Challengee. When the Challengee's answer is satisfying, accept the answer. Try to keep the conversation short."
